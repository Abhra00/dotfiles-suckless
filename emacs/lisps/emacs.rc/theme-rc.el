...
;; Overrides for modus vivendi tinted theme
(defun rc/apply-palenight-style ()
  ...
  (setopt modus-themes-italic-constructs t
          ...
          `((bg-main                   "#292D3E")
            ...
            (docstring                 "#8d92af")
            (constant                  "#f78c6c")
            (bg-term-black             "#676E95")
            (fg-term-black             "#676E95")
            (bg-term-black-bright      "#4c5374")
            (fg-term-black-bright      "#4c5374")
            (bg-term-red               "#ff5572")
            (fg-term-red               "#ff5572")
            (bg-term-red-bright        "#EF5350")
            (fg-term-red-bright        "#EF5350")
            (bg-term-green             "#C3E88D")
            (fg-term-green             "#C3E88D")
            (bg-term-green-bright      "#a9c77d")
            (fg-term-green-bright      "#a9c77d")
            (bg-term-yellow            "#ffcb6b")
            (fg-term-yellow            "#ffcb6b")
            (bg-term-yellow-bright     "#FFCA28")
            (fg-term-yellow-bright     "#FFCA28")
            (bg-term-blue              "#82AAFF")
            (fg-term-blue              "#82AAFF")
            (bg-term-blue-bright       "#64B5F6")
            (fg-term-blue-bright       "#64B5F6")
...
;; Install and load modus vivendi tinted theme
